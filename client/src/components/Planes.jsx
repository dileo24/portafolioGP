      ...
      <section id="planes" className="planesContainer">
        <div className="planesYPrecios">
          <div className="text">
            ...
            <p>
              ...
              según tus necesidades. Si este es tu caso, simplemente dirigite a
              la sección de "Contacto" y contanos lo que tenés en mente para que
        ...
        <div className="planes">
            ...
            <div className="detalles detallesBronce">
              <div className="lista">
                <p>
                  ...
                  <br />
                  <img src={check} alt="check" className="check" />
                  Vista responsive (adaptable a celulares, tablets,
                  computadora).
                  <br />
                  <br />
                  <img src={check} alt="check" className="check" />
          ...
          <div className="plan">
            ...
            <p className="text">
              ...
              productos o servicios especificos, ideal para llegar de mejor
              manera al cliente y agilizar procesos de ventas.
            </p>
        ...
        <div className="soporteTec">
          ...
          <div className="detalles">
            ...
            <div className="text">
              Brindamos un soporte técnico <b>opcional</b> con el que
              garantizamos rápida atención, flexibilidad en horarios, resolución
              de cualquier problema/fallo y actualizaciones de información en tu
              página web.
            </div>
          </div>
          <div className="precio">
