    ...
    <div className="planesContainer">
      ...
      <div className="plan">
        ...
        <p>
          ...
          maiores saepe doloremque sequi dicta? Quod sunt, a odio aliquam ipsa
          nulla deserunt quibusdam, rem cupiditate porro iste accusamus
          laboriosam!
        </p>
        <div className="detalles">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
            quod maiores saepe doloremque sequi dicta? Quod sunt, a odio aliquam
            ipsa nulla deserunt quibusdam, rem cupiditate porro iste accusamus
            laboriosam!
          </p>
        </div>
      </div>
